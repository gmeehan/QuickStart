<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActivateProductForm.aspx.cs" MasterPageFile="~/Admin/Forms/Form.Master" Inherits="QuickStartRetailer.Admin.Forms.ActivateProductForm" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div class="form_title">
        <h2 runat="server" id="formTitleHeader">Activate Product</h2>
    </div>
